...
using Microsoft.EntityFrameworkCore; //FOR CRUD --- EF extension methods
...
namespace WestWindSystem.BLL
{
    public class ProductServices
    {
        ...
        {
            //To remove record from database --- hardDelete
            //_dbContext.Products.Attach(existingProduct).State = EntityState.Deleted;

            //To mark a record as delete but keep record in database
